...
import it.csi.dma.apicodopsan.integration.notificatore.dto.EmailPayload;
import it.csi.dma.apicodopsan.integration.notificatore.dto.MexPayload;
import it.csi.dma.apicodopsan.integration.notificatore.dto.NotificaCustom;
import it.csi.dma.apicodopsan.integration.notificatore.dto.PayloadNotifica;
import it.csi.dma.apicodopsan.integration.notificatore.dto.PushPayload;
...
//	https://gitlab.csi.it/user-notification-platform/unpdocumentazione/blob/master/documentazione%20fornitori/NOTIFY-specifiche.md
	...
	public void notificaEventoAbilitaPaziente(String cfMittente,Soggetto soggetto,String xRequestId) throws Exception {
		notificaMessaggio(cfMittente,soggetto,null, xRequestId, NotificatoreEventCode.EVENTO_ABILITA_CITTADINO.getCode(), NotificatoreEventCode.EVENTO_ABILITA_CITTADINO.getCode());
	}
	public void notificaEventoAbilitaPazientePerDelegato(String cfMittente,Soggetto soggettoDelegato,String cfDelegante,String xRequestId) throws Exception {
		notificaMessaggio(cfMittente,soggettoDelegato,cfDelegante, xRequestId,  NotificatoreEventCode.EVENTO_ABILITA_CITTADINO_DELEGATO.getCode(), NotificatoreEventCode.EVENTO_ABILITA_CITTADINO_DELEGATO.getCode());
	}
	public void notificaEventoDisabilitaPaziente(String cfMittente,Soggetto soggetto,String xRequestId) throws Exception {
		notificaMessaggio(cfMittente,soggetto,null, xRequestId, NotificatoreEventCode.EVENTO_DISABILITA_CITTADINO.getCode(), NotificatoreEventCode.EVENTO_DISABILITA_CITTADINO.getCode());
	}
	public void notificaEventoDisabilitaPazientePerDelegato(String cfMittente,Soggetto soggettoDelegato,String cfDelegante,String xRequestId) throws Exception {
		notificaMessaggio(cfMittente,soggettoDelegato,cfDelegante, xRequestId,  NotificatoreEventCode.EVENTO_DISABILITA_CITTADINO_DELEGATO.getCode(), NotificatoreEventCode.EVENTO_DISABILITA_CITTADINO_DELEGATO.getCode());
	}
