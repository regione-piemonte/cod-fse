...
public interface ValidateMedicoAssistitiTuttiPost {
	...
	public List<ErroreDettaglio> validate(String shibIdentitaCodiceFiscale, String xRequestId, String xForwardedFor,
			...
			String collocazioneDescrizione, PayloadAbilitazioneTotale payloadAbilitazioneTotale, SecurityContext securityContext,
