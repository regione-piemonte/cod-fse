...
public class ModelConversazione   {
  ...
  /**
   * Indica se la conversazione Ã¨ in sola lettura
   **/
  ...
  /**
   * La data in cui verrï¿½ eliminata la conversazione
   **/
  

  @JsonProperty("data_eliminazione") 
  ...
  public ModelAssistitoMessaggio getAssistito() {
    return assistito;
  }
  public void setAssistito(ModelAssistitoMessaggio assistito) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, modelConversazione.id) &&
        ...
        Objects.equals(dataEliminazione, modelConversazione.dataEliminazione) &&
        ...
        Objects.equals(assistito, modelConversazione.assistito);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, medico, argomento, nMessaggiNonLetti, solaLettura, ultimoMessaggio, dataCreazione, dataEliminazione, motivoBlocco, motivazioneMedico, autore, assistito);
  }
  ...
  public String toString() {
    ...
    sb.append("    dataEliminazione: ").append(toIndentedString(dataEliminazione)).append("\n");
