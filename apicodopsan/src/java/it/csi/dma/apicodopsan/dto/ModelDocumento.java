...
public class ModelDocumento   {
  ...
  /**
   * Se il documento Ã¨ autocontribuito puÃ² valere TRASCRIZIONE o ALLEGATO (nel primo caso bisogna far vedere il testo nel secodo trattasi di un pdf), altrimenti viene restituito null
   **/
