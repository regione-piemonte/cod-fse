...
public class TConversazione {
	...
	public TConversazione(Long conversazioneId, String conversazioneCod, String conversazioneOggetto,
			Integer soggettoIdAutore, Integer soggettoIdPartecipante, Timestamp conversazioneDataBlocco,
			Integer disabilitazioneMotivoId, Timestamp dataCreazione, Timestamp dataModifica, String utenteCreazione,
			String utenteModifica) {
		super();
		this.conversazioneId = conversazioneId;
		this.conversazioneCod = conversazioneCod;
