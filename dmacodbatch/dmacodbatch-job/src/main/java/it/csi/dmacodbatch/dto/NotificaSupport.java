...
public class NotificaSupport implements Serializable{
	...
	public String toString() {
		return "NotificaSupport [shibIdentitaCodiceFiscale=" + shibIdentitaCodiceFiscale + ", soggettoRicevente=" + soggettoRicevente + ", requestId="
				+ requestId + ", codiceServizio=" + codiceServizio + ", codeNotificaPrincipale=" + codeNotificaPrincipale + ", codeNotificaSecondario="
