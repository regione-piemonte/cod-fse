...
public class Conversazione {
	...
	public Conversazione(Long conversazioneId, String conversazioneCod, String conversazioneOggetto, Integer soggettoIdAutore,
			Integer soggettoIdPartecipante, Timestamp conversazioneDataBlocco, Integer disabilitazioneMotivoId,
			Timestamp dataCreazione, Timestamp dataModifica, String utente_creazione, String utente_modifica) {
		super();
